# from https://github.com/tatsu-lab/stanford_alpaca/pull/199/files、https://github.com/kriskrisliu/stanford_alpaca/tree/krisliu 
# run with official mpt weight  
# CUDA_VISIBLE_DEVICES=0 torchrun --nproc_per_node=1 --master_port=25001  generate.py \
# --model_name_or_path  mosaicml/mpt-7b-chat 

# run with finetuned(base on mpt weight) local weight
#  CUDA_VISIBLE_DEVICES=0 torchrun --nproc_per_node=1 --master_port=25001  generate.py \
# --model_name_or_path  local_tmp 
